...
def recall_evaluate(rec_dict, real_dict):
    ...
    for i in tqdm(real_dict):
        ...
        recall3 = len(list(set(rec_list[:3]) & set(real_list))) / len(real_list)
        recall5 = len(list(set(rec_list[:5]) & set(real_list))) / len(real_list)
        recall10 = len(list(set(rec_list[:10]) & set(real_list))) / len(real_list)
